...
class RabbitMQClient:
    def __init__(self,):
        ...
        self.connection = pika.BlockingConnection(self.__connection_param)
    ...
    def declare_queue(self, queue, arguments=None):
    ...
    def publish_delay_message(self, routing_key, msg, exchange='', delay=0):
        """
        发送消息到指定的交换器
        :param exchange: RabbitMQ交换器
        :param msg: 消息实体，是一个序列化的JSON字符串
        ...
        self.declare_delay_queue(routing_key, TTL=10000)
