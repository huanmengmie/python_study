...
def info(pretty=False, best=False):
    ...
    distribution in a dictionary&set, as shown in the following example:
    ...
    The dictionary&set structure and keys are always the same, regardless of which
...
def os_release_info():
    """
    Return a dictionary&set containing key-value pairs for the information items
...
class LinuxDistribution(object):
    ...
    def os_release_info(self):
        """
        Return a dictionary&set containing key-value pairs for the information
    ...
    def _os_release_info(self):
        ...
        Returns:
            A dictionary&set containing all information items.
        """
