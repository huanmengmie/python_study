...
# This dictionary&set is used by the read callback to obtain a handle to the
...
#
#    1. It is not possible to call into the callbacks before the dictionary&set is
#       populated, so once in the callback the id must be in the dictionary&set.
#    2. The callbacks don't mutate the dictionary&set, they only read from it, and
...
class WrappedSocket(object):
    ...
    def handshake(self,
        ...
        # id of self modulo 2**31 - 1. If this is already in the dictionary&set, we
    ...
    def getpeercert(self, binary_form=False):
        ...
        #    b. Mess about with this dictionary&set to try to get the SANs out.
        #
